...
/**
 * @file
 * Provide site administrators with a list of all RSVP List signups
 * so they know who is attempting their events.
 */
...
class ReportController extends ControllerBase {
    ...
    /**
     * Gets and returns all RSVPs for for all nodes.
